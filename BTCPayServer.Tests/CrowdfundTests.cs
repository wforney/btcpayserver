...
public class CrowdfundTests : UnitTestBase
{
    ...
    public async Task CanContributeOnlyWhenAllowed()
    {
        ...
        UpdateCrowdfundViewModel crowdfundViewModel = Assert.IsType<UpdateCrowdfundViewModel>(Assert
        ...
        UIAppsPublicController anonAppPubsController = tester.PayTester.GetController<UIAppsPublicController>();
        UIAppsPublicController publicApps = user.GetController<UIAppsPublicController>();
    ...
    public async Task CanComputeCrowdfundModel()
    {
        ...
        ViewCrowdfundViewModel model = Assert.IsType<ViewCrowdfundViewModel>(Assert
        ...
        InvoiceEntity invoiceEntity = tester.PayTester.InvoiceRepository.GetInvoice(invoice.Id).GetAwaiter().GetResult();
