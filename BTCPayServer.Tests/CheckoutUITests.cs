...
public class CheckoutUITests : UnitTestBase
{
    ...
    public async Task CanHandleRefundEmailForm()
    {
        ...
        s.Driver.FindElement(By.Id("emailAddressForm")).FindElement(By.CssSelector("button.action-button"))
            .Click();
        IWebElement formInput = s.Driver.FindElement(By.Id("emailAddressFormInput"));
        ...
        IWebElement actionButton = s.Driver.FindElement(By.Id("emailAddressForm")).FindElement(By.CssSelector("button.action-button"));
        actionButton.Click();
    ...
    public async Task CanHandleRefundEmailForm2()
    {
        ...
        IWebElement emailInput = s.Driver.FindElement(By.Id("emailAddressFormInput"));
    ...
    public async Task CanUseLanguageDropdown()
    {
        ...
        IWebElement prettyDropdown = s.Driver.FindElement(By.Id("prettydropdown-DefaultLang"));
    ...
    public async Task CanUseJSModal()
    {
        ...
        Services.Invoices.InvoiceEntity invoice = await s.Server.PayTester.InvoiceRepository.GetInvoice(invoiceId);
        s.Driver.Navigate()
        ...
        TestUtils.Eventually(() =>
        {
            IWebElement frameElement = s.Driver.FindElement(By.Name("btcpay"));
            IWebDriver iframe = s.Driver.SwitchTo().Frame(frameElement);
