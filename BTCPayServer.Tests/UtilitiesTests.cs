...
public class UtilitiesTests
{
    ...
    public async Task PullTransifexTranslations()
    {
        ...
        JObject json = await client.GetTransifexAsync("https://api.transifex.com/organizations/btcpayserver/projects/btcpayserver/resources/enjson/");
        ...
        Task.WaitAll(langs.Select(async l =>
        {
            ...
            JObject j = await client.GetTransifexAsync($"https://www.transifex.com/api/2/project/btcpayserver/resource/enjson/translation/{l}/");
            if (!isSourceLang)
            {
