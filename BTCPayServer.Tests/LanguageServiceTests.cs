...
public class LanguageServiceTests : UnitTestBase
{
    ...
    public async Task CanAutoDetectLanguage()
    {
        ...
        LanguageService languageService = tester.PayTester.GetService<LanguageService>();
        ...
        Language lang1 = languageService.FindLanguageInAcceptLanguageHeader("nl,fr;q=0.7,en;q=0.5");
        ...
        Language lang2 = languageService.FindLanguageInAcceptLanguageHeader("nl-BE,fr;q=0.7,en;q=0.5");
        ...
        Language lang3 = languageService.FindLanguageInAcceptLanguageHeader("nl;q=0.1,fr;q=0.7,en;q=0.5");
        ...
        Language lang4 = languageService.FindLanguageInAcceptLanguageHeader("xx,*;q=0.5");
        Assert.Null(lang4);
    }
}
