...
public class PSBTTests : UnitTestBase
{
    ...
    public async Task CanPlayWithPSBT()
    {
        ...
        (string storeName, string storeId) hot = s.CreateNewStore();
        Mnemonic seed = s.GenerateWallet(isHotWallet: true);
        (string storeName, string storeId) cold = s.CreateNewStore();
        ...
        PSBT signedPSBT = psbtParsed.Clone();
