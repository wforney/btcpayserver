...
public partial class AddressMapping : Migration
{
    ...
    {
        int? maxLength = this.IsMySql(migrationBuilder.ActiveProvider) ? 255 : null;
        migrationBuilder.CreateTable(
            name: "AddressInvoices",
            columns: table => new
            {
                Address = table.Column<string>(nullable: false, maxLength: this.IsMySql(migrationBuilder.ActiveProvider) ? 512 : null),
