...
public partial class BTCPayServerClient
{
    ...
    {
        HttpResponseMessage response = await _httpClient.SendAsync(CreateHttpRequest($"api/v1/stores/{storeId}/webhooks", bodyPayload: create, method: HttpMethod.Post), token);
    ...
    {
        HttpResponseMessage response = await _httpClient.SendAsync(CreateHttpRequest($"api/v1/stores/{storeId}/webhooks/{webhookId}"), token);
    ...
    {
        HttpResponseMessage response = await _httpClient.SendAsync(CreateHttpRequest($"api/v1/stores/{storeId}/webhooks/{webhookId}", bodyPayload: update, method: HttpMethod.Put), token);
        return await HandleResponse<StoreWebhookData>(response);
    }
    public virtual async Task<bool> DeleteWebhook(string storeId, string webhookId, CancellationToken token = default)
    {
        HttpResponseMessage response = await _httpClient.SendAsync(CreateHttpRequest($"api/v1/stores/{storeId}/webhooks/{webhookId}", method: HttpMethod.Delete), token);
        return response.IsSuccessStatusCode;
    }
    public virtual async Task<StoreWebhookData[]> GetWebhooks(string storeId, CancellationToken token = default)
    {
        HttpResponseMessage response = await _httpClient.SendAsync(CreateHttpRequest($"api/v1/stores/{storeId}/webhooks"), token);
        return await HandleResponse<StoreWebhookData[]>(response);
    }
    ...
    {
        HttpResponseMessage response = await _httpClient.SendAsync(CreateHttpRequest($"api/v1/stores/{storeId}/webhooks/{webhookId}/deliveries"), token);
    ...
    {
        HttpResponseMessage response = await _httpClient.SendAsync(CreateHttpRequest($"api/v1/stores/{storeId}/webhooks/{webhookId}/deliveries/{deliveryId}"), token);
        if (response.StatusCode == System.Net.HttpStatusCode.NotFound)
        {
            return null;
        }
    ...
    {
        HttpResponseMessage response = await _httpClient.SendAsync(CreateHttpRequest($"api/v1/stores/{storeId}/webhooks/{webhookId}/deliveries/{deliveryId}/redeliver", null, HttpMethod.Post), token);
    ...
    {
        HttpResponseMessage response = await _httpClient.SendAsync(CreateHttpRequest($"api/v1/stores/{storeId}/webhooks/{webhookId}/deliveries/{deliveryId}/request"), token);
        if (response.StatusCode == System.Net.HttpStatusCode.NotFound)
        {
            return null;
        }
