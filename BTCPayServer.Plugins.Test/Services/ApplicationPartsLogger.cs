...
public class ApplicationPartsLogger : IHostedService
{
    ...
    public Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        System.Collections.Generic.IEnumerable<string> applicationParts = _partManager.ApplicationParts.Select(x => x.Name);
        ...
        System.Collections.Generic.IEnumerable<string> controllers = controllerFeature.Controllers.Select(x => x.Name);
