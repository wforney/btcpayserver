...
public class ContentSecurityPolicies
{
    ...
    private readonly HashSet<ConsentSecurityPolicy> _Policies = new HashSet<ConsentSecurityPolicy>();
    ...
    private bool allowUnsafeHashes = false;
    /// <summary>
    ...
    private static string GetSha256(string script)
    {
    ...
    public override string ToString()
    {
        ...
        foreach (IGrouping<string, ConsentSecurityPolicy> group in Rules.GroupBy(r => r.Name))
        {
            if (!firstGroup)
            {
                value.Append(';');
            ...
            foreach (ConsentSecurityPolicy v in group)
            {
