...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        ServiceDescriptor descriptor = services.Single(descriptor => descriptor.ServiceType == typeof(Fido2Configuration));
        services.Remove(descriptor);
        services.AddScoped(provider =>
        {
            IHttpContextAccessor httpContext = provider.GetService<IHttpContextAccessor>();
        ...
        {
            IPAddress bindAddress = Configuration.GetOrDefault<IPAddress>("bind", IPAddress.Any);
