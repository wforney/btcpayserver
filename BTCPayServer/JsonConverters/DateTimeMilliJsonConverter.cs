...
internal class DateTimeMilliJsonConverter : JsonConverter
{
    ...
    public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
    {
        ...
        DateTimeOffset result = UnixTimeToDateTime((ulong)(long)reader.Value);
    ...
    {
        DateTimeOffset date = ((DateTimeOffset)time).ToUniversalTime();
