...
public class TemporaryLocalFileProvider : IFileProvider
{
    ...
    public IFileInfo GetFileInfo(string tmpFileId)
    {
        ...
        TemporaryLocalFileDescriptor descriptor = JsonConvert.DeserializeObject<TemporaryLocalFileDescriptor>(text);
        ...
        Data.StoredFile storedFile = _storedFileRepository.GetFile(descriptor.FileId).GetAwaiter().GetResult();
