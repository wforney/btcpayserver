...
public class StoreBlob
{
    ...
    private CurrencyPair[] _DefaultCurrencyPairs;
    ...
    private string _LightningDescriptionTemplate;
    ...
    public BTCPayServer.Rating.RateRules GetRateRules(BTCPayNetworkProvider networkProvider)
    {
        if (!RateScripting ||
            ...
            !BTCPayServer.Rating.RateRules.TryParse(RateScript, out RateRules rules))
        {
    ...
    public RateRules GetDefaultRateRules(BTCPayNetworkProvider networkProvider)
    {
        ...
        foreach (BTCPayNetworkBase network in networkProvider.GetAll())
        {
        ...
        BTCPayServer.Rating.RateRules.TryParse(builder.ToString(), out RateRules rules);
        rules.Spread = Spread;
        return rules;
    }
