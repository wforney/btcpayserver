...
public class BitcoinPaymentType : PaymentType
{
    ...
    public override ISupportedPaymentMethod DeserializeSupportedPaymentMethod(BTCPayNetworkBase network, JToken value)
    {
        ...
        {
            DerivationSchemeSettings scheme = net.NBXplorerNetwork.Serializer.ToObject<DerivationSchemeSettings>(jobj);
            scheme.Network = net;
            return scheme;
        }
        // Legacy
        ...
        Money cryptoInfoDue, string serverUri)
    {
        ...
        Common.PaymentUrlBuilder bip21 = ((BTCPayNetwork)network).GenerateBIP21(paymentMethodDetails.GetPaymentDestination(), cryptoInfoDue);
