...
#pragma warning disable CS0618 // Type or member is obsolete
        ...
        {
            if (!BTCPayServer.Lightning.LightningConnectionString.TryParse(LightningConnectionString, false, out LightningConnectionString? connectionString, out var error))
            {
...
#pragma warning disable CS0618 // Type or member is obsolete
        if (!string.IsNullOrEmpty(LightningConnectionString) &&
            BTCPayServer.Lightning.LightningConnectionString.TryParse(LightningConnectionString, false, out LightningConnectionString? conn))
        {
