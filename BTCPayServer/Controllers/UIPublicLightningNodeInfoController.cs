...
public class UIPublicLightningNodeInfoController : Controller
{
    ...
    public async Task<IActionResult> ShowLightningNodeInfo(string storeId, string cryptoCode)
    {
        ...
        try
        {
            LightningSupportedPaymentMethod paymentMethodDetails = GetExistingLightningSupportedPaymentMethod(cryptoCode, store);
    ...
    private LightningSupportedPaymentMethod GetExistingLightningSupportedPaymentMethod(string cryptoCode, StoreData store)
    {
        ...
        LightningSupportedPaymentMethod existing = store.GetSupportedPaymentMethods(_BtcPayNetworkProvider)
