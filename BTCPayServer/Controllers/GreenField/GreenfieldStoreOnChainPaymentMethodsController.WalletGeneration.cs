...
public partial class GreenfieldStoreOnChainPaymentMethodsController
{
        ...
        GenerateWalletRequest request)
    {
        ...
        AssertCryptoCodeWallet(cryptoCode, out BTCPayNetwork network, out Services.Wallets.BTCPayWallet wallet);
        ...
        (bool HotWallet, bool RPCImport) canUseHotWallet = await CanUseHotWallet();
        ...
        NBXplorer.ExplorerClient client = _explorerClientProvider.GetExplorerClient(network);
        ...
        var derivationSchemeSettings = new DerivationSchemeSettings(response.DerivationScheme, network)
        {
            ...
            IsHotWallet = request.SavePrivateKeys
        };
        ...
        OnChainPaymentMethodData rawResult = GetExistingBtcLikePaymentMethod(cryptoCode, store);
