...
public class GreenfieldStoresController : ControllerBase
{
    ...
    {
        StoreData[] stores = HttpContext.GetStoresData();
    ...
    public async Task<IActionResult> CreateStore(CreateStoreRequest request)
    {
        ...
        PaymentMethodId.TryParse(request.DefaultPaymentMethod, out PaymentMethodId defaultPaymentMethodId);
    ...
    {
        StoreBlob storeBlob = data.GetStoreBlob();
    ...
    {
        StoreBlob blob = model.GetStoreBlob();
