...
public class UIErrorController : Controller
{
    ...
    {
        if (Request.Headers.TryGetValue("Accept", out Microsoft.Extensions.Primitives.StringValues v) && v.Any(v => v.Contains("text/html", StringComparison.OrdinalIgnoreCase)))
        {
