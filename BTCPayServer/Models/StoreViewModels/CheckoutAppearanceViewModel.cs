...
public class CheckoutAppearanceViewModel
{
    ...
    public void SetLanguages(LanguageService langService, string defaultLang)
    {
        ...
        IOrderedEnumerable<Format> choices = langService.GetLanguages().Select(o => new Format() { Name = o.DisplayName, Value = o.Code }).ToArray().OrderBy(o => o.Name);
        Format chosen = choices.FirstOrDefault(f => f.Value == defaultLang) ?? choices.FirstOrDefault();
