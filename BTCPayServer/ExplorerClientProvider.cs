...
{
    private readonly BTCPayNetworkProvider _NetworkProviders;
        ...
        Logs logs)
    {
        ...
        foreach (NBXplorerConnectionSetting setting in nbXplorerOptions.Value.NBXplorerConnectionSettings)
        {
    ...
    private ExplorerClient CreateExplorerClient(HttpClient httpClient, BTCPayNetwork n, Uri uri,
        string cookieFile)
    {
        ExplorerClient explorer = n.NBXplorerNetwork.CreateExplorerClient(uri);
    ...
    private readonly Dictionary<string, ExplorerClient> _Clients = new Dictionary<string, ExplorerClient>();
    ...
    public bool IsAvailable(string cryptoCode)
    {
        ...
        return _Clients.ContainsKey(cryptoCode) && _Dashboard.IsFullySynched(cryptoCode, out NBXplorerDashboard.NBXplorerSummary unused);
    }
    ...
    {
        foreach (BTCPayNetwork net in _NetworkProviders.GetAll().OfType<BTCPayNetwork>())
        {
