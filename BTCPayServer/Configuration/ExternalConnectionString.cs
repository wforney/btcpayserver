...
public class ExternalConnectionString
{
    ...
    {
        ExternalConnectionString connectionString = Clone();
        // Transform relative URI into absolute URI
        Uri serviceUri = connectionString.Server.IsAbsoluteUri ? connectionString.Server : ToRelative(absoluteUrlBase, connectionString.Server.ToString());
