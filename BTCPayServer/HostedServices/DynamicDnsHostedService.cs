...
public class DynamicDnsHostedService : BaseAsyncService
{
    ...
    private async Task UpdateRecord()
    {
        ...
        {
            DynamicDnsSettings settings = await SettingsRepository.GetSettingAsync<DynamicDnsSettings>() ?? new DynamicDnsSettings();
            foreach (DynamicDnsService service in settings.Services)
            {
        ...
        Task<DynamicDnsSettings> changed = SettingsRepository.WaitSettingsChanged<DynamicDnsSettings>(Cancellation);
