...
{
    private readonly Dictionary<PaymentMethodId, PaymentMethod> _Inner = new Dictionary<PaymentMethodId, PaymentMethod>();
    ...
    {
        PaymentMethodId key = paymentMethod.GetId();
        _Inner.Remove(key);
    ...
    {
        ArgumentNullException.ThrowIfNull(paymentMethodId);
        _Inner.TryGetValue(paymentMethodId, out PaymentMethod value);
        return value;
    }
